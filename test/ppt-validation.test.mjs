...
beforeAll(async () => {
  ...
  const { core } = JSON.parse(await readFile('packages/ppt-runtime/artifacts.json', 'utf8'))
  execFileSync('tar', ['-xzf', path.join('packages/ppt-bundles', core.file), '-C', packageRoot, '--strip-components=1'])
