...
function artifactFor(name) {
  const artifacts = {
    ...
    '@opc/DSH-ai-customer-service': 'opc-DSH-ai-customer-service-0.1.20.tgz',
    ...
    '@opc/dsh-viral-chase': 'opc-dsh-viral-chase-0.1.16.tgz'
  }
  return `plugins/${artifacts[name]}`
}

function versionFor(name) {
  if (name === '@opc/DSH-ai-customer-service') return '0.1.20'
