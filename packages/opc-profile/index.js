...
function artifactFor(name) {
  const artifacts = {
    ...
    '@opc/dsh-douyin-comment-ops': 'opc-dsh-douyin-comment-ops-0.1.2.tgz',
    ...
    '@opc/dsh-viral-chase': 'opc-dsh-viral-chase-0.1.21.tgz'
  }
  return `plugins/${artifacts[name]}`
}

function versionFor(name) {
  if (name === '@opc/dsh-douyin-comment-ops') return '0.1.2'
  ...
  if (name === '@opc/dsh-viral-chase') return '0.1.21'
