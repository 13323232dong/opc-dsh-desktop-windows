...
function artifactFor(name) {
  const artifacts = {
    '@opc/dsh-brand': 'opc-dsh-brand-0.1.1.tgz',
    ...
    '@opc/dsh-dev-status-control': 'opc-dsh-dev-status-control-0.2.3.tgz',
...
function versionFor(name) {
  ...
  if (name === '@opc/dsh-dev-status-control') return '0.2.3'
  if (name === '@opc/dsh-brand') return '0.1.1'
  return '0.1.0'
}
