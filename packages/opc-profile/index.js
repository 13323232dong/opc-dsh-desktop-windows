...
function artifactFor(name) {
  const artifacts = {
    ...
    '@opc/DSH-ai-customer-service': 'opc-DSH-ai-customer-service-0.1.13.tgz',
    ...
    '@opc/dsh-realtime-voice': 'opc-dsh-realtime-voice-0.1.3.tgz',
    ...
    '@opc/dsh-viral-chase': 'opc-dsh-viral-chase-0.1.10.tgz'
  }
  return `plugins/${artifacts[name]}`
}

function versionFor(name) {
  if (name === '@opc/DSH-ai-customer-service') return '0.1.13'
  ...
  if (name === '@opc/dsh-viral-chase') return '0.1.10'
  if (name === '@opc/dsh-dev-status-control') return '0.2.4'
  if (name === '@opc/dsh-brand') return '0.1.4'
  if (name === '@opc/dsh-realtime-voice') return '0.1.3'
  return '0.1.0'
}
