...
function artifactFor(name) {
  const artifacts = {
    ...
    '@opc/DSH-ai-customer-service': 'opc-DSH-ai-customer-service-0.1.10.tgz',
    ...
    '@opc/dsh-viral-chase': 'opc-dsh-viral-chase-0.1.7.tgz'
  }
  return `plugins/${artifacts[name]}`
}

function versionFor(name) {
  if (name === '@opc/DSH-ai-customer-service') return '0.1.10'
  ...
  if (name === '@opc/dsh-viral-chase') return '0.1.7'
