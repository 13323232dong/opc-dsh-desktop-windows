...
function artifactFor(name) {
  const artifacts = {
    ...
    '@opc/DSH-ai-customer-service': 'opc-DSH-ai-customer-service-0.1.17.tgz',
    ...
    '@opc/dsh-realtime-voice': 'opc-dsh-realtime-voice-0.1.5.tgz',
...
function versionFor(name) {
  if (name === '@opc/DSH-ai-customer-service') return '0.1.17'
  ...
  if (name === '@opc/dsh-realtime-voice') return '0.1.5'
  return '0.1.0'
}
