...
export interface AgentTeamsCardInjected {
    readonly openMemberSession: (captainSessionId: SessionId, memberSessionId: SessionId) => Promise<boolean>;
}
...
export declare function AgentTeamsCard({ node, openMemberSession, sessionId }: AgentTeamsCardProps): import("react").JSX.Element;
