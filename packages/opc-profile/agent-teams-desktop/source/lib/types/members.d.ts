...
import { type SoulProfile } from './soul.ts';
...
export interface MemberLlmSelectionRequest {
    ...
    model?: string;
    /** Profile-level provider default paired with `defaultModel`. */
 ...
 */
export declare function memberPersona(team: TeamState, member: TeamMember, stateDir: string, soul?: SoulProfile): string;
/**
 ...
 */
export declare function spawnMember(ctx: Context, config: MemberRuntimeConfig, selections: MemberSelectionRuntime, llmSelection: MemberLlmSelection, captain: Agent, team: TeamState, member: TeamMember, stateDir: string, signal: AbortSignal, soul?: SoulProfile): Promise<void>;
/**
 ...
 */
export declare function reconcileProvisioningMembers(ctx: Context, captain: Agent, stateRoot: string, teamId: string): Promise<void>;
/**
