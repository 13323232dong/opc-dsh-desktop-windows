		...
		* (historical session review). */
		...
		function ToolLibraryView({ sessionId, client, conversationId, runId }) {
			...
			(0, react.useEffect)(() => {
				...
				client.listTools(controller.signal).then((next) => {
			...
			if (state === "error") return (0, react_jsx_runtime.jsxs)("div", {
				className: ToolLibraryView_module_css_default.loadState,
				role: "alert",
				children: [(0, react_jsx_runtime.jsx)("strong", { children: "工具库暂时无法加载" }), (0, react_jsx_runtime.jsx)("span", { children: "服务端身份未配置或网关不可用。" })]
			});
			return (0, react_jsx_runtime.jsxs)("div", {
